...
The To, CC, and BCC fields support searching and selecting from SuiteCRM Accounts, Contacts, Leads, Users, or individual email addresses using the new Multi-Flex-Relate field.

Attachments have been implemented using the new storage system
...
===== icon:file[] New File Upload Field Types - Phase 1

SuiteCRM 8.9 introduces two new field types for handling file uploads: `file` and `attachment`.

{{% notice note %}}
Note: Documents and Notes do not yet use the new fields or the new storage system. The migration of these modules to SuiteCRM 8 version will be provided in a future release.
{{% /notice %}}

**file** - For single file uploads.

* For more information see link:../../configuration/file-storage/8.9.0-file-field-type[File Field Type] documentation.

image:file-upload-field-detail.png[File Field Detail]

**attachment** - For multiple file uploads.

* For more information see link:../../configuration/file-storage/8.9.0-attachment-field-type[Attachment Field Type] documentation.

image:attchments-field-detail.png[Attachments Field Detail]


===== icon:file[] New Media Storage System - Phase 1
...
{{% notice note %}}
Note: This release does not yet include a migration path for old files stored in the legacy `upload` directory. A migration path will be provided in a future release.
{{% /notice %}}
...
{{% notice note %}}
Note: For the moment this field is not available in the Studio. A future release will include Studio support.
{{% /notice %}}
...
* link:../../../developer/extensions/backend/fields/async-validator/field-async-validator[Backend driven Save Validators]
* link:../../../developer/extensions/backend/fields/init-default-process/field-init-default-process[Backend driven default value initialization]
* link:../../../developer/extensions/backend/fields/footnotes/field-footnotes[Field Footnotes]
* File upload fields and storage
