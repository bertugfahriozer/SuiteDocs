---
title: "Adding an init Default Process to a Field"
weight: 20
---
...
In SuiteCRM 8, you can add `initDefaultProcess` to fields definitions.
...
. On `PhoneAsyncValidator.php`, add the code on the snippet on link:./#_2_3_init_default_process_implementation[2.2 Async Validator implementation] section
