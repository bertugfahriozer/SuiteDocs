...
* Tasarımda yalnızca bir yazı tipi kullanılır; bu Google Fonts üzerinden sağlanır.
* Kullanılan yazı tipi `Lato`dır: https://fonts.google.com/specimen/Lato

== Renkler

Below are the primary colours used in the theme (preserved as visual blocks):
